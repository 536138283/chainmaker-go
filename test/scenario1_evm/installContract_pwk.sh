...
--admin-key-file-paths=../config/wx-org1.chainmaker.org/keys/user/admin1/admin1.key,../config/wx-org2.chainmaker.org/keys/user/admin1/admin1.key,../config/wx-org3.chainmaker.org/keys/user/admin1/admin1.key \
