...
def UpdateSetting():
    gl.TESTPROJECTPATH= r"/Users/devinzeng/go/src/chainmaker.org/chainmaker-go/test/chain2/bin"
    gl.CMC_TOOL_PATH = "cd /Users/devinzeng/go/src/chainmaker.org/chainmaker-go/test/chain2/bin && "
