...
func getLastBlock() error {
	...
	payloadBytes, err := constructQueryPayload(chainId, syscontract.SystemContract_CHAIN_QUERY.String(), "GET_LAST_BLOCK", pairs)
	if err != nil {
		return err
	}
