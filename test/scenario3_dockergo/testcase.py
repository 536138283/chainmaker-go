...
class Test(unittest.TestCase):
    def test_erc20_go(self):
        ...
        result_withdraw = cd_erc.create("DOCKER_GO", "withdraw.7z", public_identity=f'{gl.ACCOUNT_TYPE}', sdk_config='sdk_config.yml',endorserKeys=f'{gl.ADMIN_KEY_FILE_PATHS}',endorserCerts=f'{gl.ADMIN_CRT_FILE_PATHS}',endorserOrgs=f'{gl.ADMIN_ORG_IDS}')
        ...
        cd_withdraw.invoke("withdraw", params="{{\"to\":\"{}\",\"amount\":\"{}\"}}".format(user_b_address,100),
