...
class ContractDeal(object):
    ...
    def create(self, runtime, wasm, params=None, public_identity=None, sdk_config=None,endorserKeys =None,endorserCerts=None,endorserOrgs=None):
        """
        支持创建普通sql合约以及kv合约
    ...
    def invoke(self, method, params, sdk_config=None, signkey=None, signcrt=None, org=None):
        """
        调用合约
        :param method: 调用合约方法
    ...
    def get(self, method, params, sdk_config=None, signkey=None, signcrt=None, org=None):
        """
        查询合约
...
if __name__ == "__main__":
    ...
    # print(cd.unfreeze())
    # print(cd.revoke())
    cd = ContractDeal("asset", sync_result=True)
