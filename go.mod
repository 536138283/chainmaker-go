...
require (
	...
	chainmaker.org/chainmaker/consensus-maxbft/v3 v3.0.1-0.20230316075144-ff93d9b85677
	...
	chainmaker.org/chainmaker/vm-native/v3 v3.0.1-0.20230317030642-5d10af3ca059
