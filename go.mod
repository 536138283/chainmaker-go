...
require (
	...
	chainmaker.org/chainmaker/consensus-maxbft/v3 v3.0.1-0.20231207084951-9e8fcc8d673f
	...
	chainmaker.org/chainmaker/vm-engine/v3 v3.0.1-0.20231109095137-fa539a8d3a0a
