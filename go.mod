...
require (
	...
	chainmaker.org/chainmaker/consensus-tbft/v2 v2.2.2-0.20220902073141-4ac8b21b5e2b
	...
	chainmaker.org/chainmaker/vm-docker-go/v2 v2.2.4-0.20220907063820-6650c8424d68
