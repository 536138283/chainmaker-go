...
require (
	...
	chainmaker.org/chainmaker/consensus-tbft/v2 v2.3.2-0.20221107032712-356326f776ba
	...
	chainmaker.org/chainmaker/store/v2 v2.3.3-0.20221107063648-065ff1bffb8a
