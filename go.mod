...
require (
	...
	chainmaker.org/chainmaker/consensus-maxbft/v2 v2.2.1-0.20220725035501-db46b5d6adc7
	...
	chainmaker.org/chainmaker/txpool-normal/v2 v2.0.0-20220722072116-346f1e8c82ea
