...
require (
	...
	chainmaker.org/chainmaker/consensus-maxbft/v2 v2.2.1-0.20220822034214-ecf0195fc68b
	...
	chainmaker.org/chainmaker/pb-go/v2 v2.2.2-0.20220823082600-9d247279107b
