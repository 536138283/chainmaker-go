...
require (
	...
	chainmaker.org/chainmaker/consensus-maxbft/v2 v2.2.1-0.20220819091301-34be5ca1a386
	...
	chainmaker.org/chainmaker/protocol/v2 v2.2.3-0.20220819074746-247b5f96acc6
