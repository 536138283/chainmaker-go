...
type RuntimeInstance interface {
	...
	Invoke(contractId *commonPb.ContractId, method string, byteCode []byte, parameters map[string]string,
		txContext protocol.TxSimContext, gasUsed uint64) (*commonPb.ContractResult, protocol.ExecOrderTxType)
}
...
func (m *ManagerImpl) RunContract(contractId *commonPb.ContractId, method string, byteCode []byte,
	...
	*commonPb.ContractResult, protocol.ExecOrderTxType, commonPb.TxStatusCode) {
	...
	if contractName == "" {
		...
		return contractResult, protocol.ExecOrderTxTypeNormal, commonPb.TxStatusCode_INVALID_CONTRACT_PARAMETER_CONTRACT_NAME
	}
	...
	if revokeInfo, err := txContextGet(txContext, contractName, protocol.ContractRevoke); err != nil {
		...
		return contractResult, protocol.ExecOrderTxTypeNormal, commonPb.TxStatusCode_GET_FROM_TX_CONTEXT_FAILED
	...
	if native.IsNative(contractName, refTxType) {
		if method == "" {
			...
			return contractResult, protocol.ExecOrderTxTypeNormal, commonPb.TxStatusCode_INVALID_CONTRACT_PARAMETER_METHOD
		}
...
func (m *ManagerImpl) runNativeContract(contractId *commonPb.ContractId, method string, parameters map[string]string,
	txContext protocol.TxSimContext) (*commonPb.ContractResult, protocol.ExecOrderTxType, commonPb.TxStatusCode) {
...
func (m *ManagerImpl) runUserContract(contractId *commonPb.ContractId, method string, byteCode []byte,
	...
	if refTxType == commonPb.TxType_INVOKE_USER_CONTRACT || refTxType == commonPb.TxType_QUERY_USER_CONTRACT {
		...
		if code != commonPb.TxStatusCode_SUCCESS {
			return result, protocol.ExecOrderTxTypeNormal, code
		}
	...
	case commonPb.ManageUserContractFunction_INIT_CONTRACT.String():
		...
		if byteCode == nil {
			...
			return contractResult, protocol.ExecOrderTxTypeNormal, commonPb.TxStatusCode_INVALID_CONTRACT_PARAMETER_BYTE_CODE
		}
		...
		if err := txContext.Put(commonPb.ContractName_SYSTEM_CONTRACT_STATE.String(), versionKey, []byte(version)); err != nil {
			...
			return contractResult, protocol.ExecOrderTxTypeNormal, commonPb.TxStatusCode_PUT_INTO_TX_CONTEXT_FAILED
		}
	...
	case commonPb.ManageUserContractFunction_UPGRADE_CONTRACT.String():
		...
		if byteCodeInContext, err := txContextGetVersionBytecode(txContext, contractName, version); err != nil {
			...
			return contractResult, protocol.ExecOrderTxTypeNormal, commonPb.TxStatusCode_CONTRACT_VERSION_EXIST_FAILED
		}
...
func (m *ManagerImpl) invokeUserContractByRuntime(contractId *commonPb.ContractId, method string,
	...
	*commonPb.ContractResult, protocol.ExecOrderTxType, commonPb.TxStatusCode) {
	...
	if creator == nil {
		...
		return contractResult, protocol.ExecOrderTxTypeNormal, commonPb.TxStatusCode_GET_CREATOR_FAILED
	}

	sender, code := getFullCertMember(sender, txContext)
	if code != commonPb.TxStatusCode_SUCCESS {
		return contractResult, protocol.ExecOrderTxTypeNormal, code
	}
	...
	if senderMember, err := m.AccessControl.NewMemberFromProto(sender); err != nil {
		...
		return contractResult, protocol.ExecOrderTxTypeNormal, commonPb.TxStatusCode_UNMARSHAL_SENDER_FAILED
	} else {
	...
	if creatorMember, err := m.AccessControl.NewMemberFromProto(creator); err != nil {
		...
		return contractResult, protocol.ExecOrderTxTypeNormal, commonPb.TxStatusCode_UNMARSHAL_CREATOR_FAILED
	} else {
