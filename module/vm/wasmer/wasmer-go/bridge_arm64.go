...
// #cgo LDFLAGS: -Wl,-rpath,${SRCDIR} -L${SRCDIR} -lwasmer-arm
// #include "./wasmer.h"
//
import "C"
import "unsafe"
...
// @by taifu
// Stop executing the current instance
func cWasmerTrap(
...
func cWasmerGetPointsUsed(instance *cWasmerInstanceT) cUint64T {
	return (cUint64T)(C.get_points_used(
		(*C.wasmer_instance_t)(instance),
	))
}

func cWasmerSetPointsUsed(instance *cWasmerInstanceT, value cUint64T) {
	C.set_points_used(
		(*C.wasmer_instance_t)(instance),
		(C.uint64_t)(value),
	)
...
func cWasmerSetPointsLimit(instance *cWasmerInstanceT, value cUint64T) {
	C.set_points_limit(
		(*C.wasmer_instance_t)(instance),
		(C.uint64_t)(value),
	)
