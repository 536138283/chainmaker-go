...
func (vb *VerifierBlock) ValidateBlock(
	block, lastBlock *commonpb.Block, timeLasts []int64) (map[string]*commonpb.TxRWSet, map[string][]*commonpb.ContractEvent, []int64, error) {
...
func CheckPreBlock(block *commonpb.Block, lastBlock *commonpb.Block) error {
	...
	return IsPreHashValid(block, lastBlock.Header.BlockHash)
}
