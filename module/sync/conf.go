...
type BlockSyncServerConf struct {
	...
	minLagThreshold      uint64 //The mininum difference between the local block height and the maximum height of other peers, if reach, maybe should stop syncing blocks from peers
}
