#
# Copyright (C) Beijing Advanced Innovation Center for
# Future Blockchain and Privacy Computing (未来区块链与隐私计算⾼精尖创新中⼼). All rights reserved.
...
# permissionedWithIBC: permissioned blockchain, using meaningful string to identify members.
# permissionedWithIBC identify rule : id=“nodeId“;org=”organization“;type=”userType“;vb=”start time“;ve=”End time“
# public: public blockchain, using public key to identify members.
auth_type: "permissionedWithIBC"
...
# IBC Master keys is used to specify the organizations' master public key in IBC mode.
ibc_master_keys:
  - org_id: "{org1_id}"
    master_keys:
      - "../config/{org_path}/certs/ca/{org1_id}/master_public.key"
  - org_id: "{org2_id}"
    master_keys:
      - "../config/{org_path}/certs/ca/{org2_id}/master_public.key"
  - org_id: "{org3_id}"
    master_keys:
      - "../config/{org_path}/certs/ca/{org3_id}/master_public.key"
  - org_id: "{org4_id}"
    master_keys:
      - "../config/{org_path}/certs/ca/{org4_id}/master_public.key"
  - org_id: "{org5_id}"
    master_keys:
      - "../config/{org_path}/certs/ca/{org5_id}/master_public.key"
  - org_id: "{org6_id}"
    master_keys:
      - "../config/{org_path}/certs/ca/{org6_id}/master_public.key"
  - org_id: "{org7_id}"
    master_keys:
      - "../config/{org_path}/certs/ca/{org7_id}/master_public.key"
  - org_id: "{org8_id}"
    master_keys:
      - "../config/{org_path}/certs/ca/{org8_id}/master_public.key"
  - org_id: "{org9_id}"
    master_keys:
      - "../config/{org_path}/certs/ca/{org9_id}/master_public.key"
  - org_id: "{org10_id}"
    master_keys:
      - "../config/{org_path}/certs/ca/{org10_id}/master_public.key"
  - org_id: "{org11_id}"
    master_keys:
      - "../config/{org_path}/certs/ca/{org11_id}/master_public.key"
  - org_id: "{org12_id}"
    master_keys:
      - "../config/{org_path}/certs/ca/{org12_id}/master_public.key"
  - org_id: "{org13_id}"
    master_keys:
      - "../config/{org_path}/certs/ca/{org13_id}/master_public.key"
  - org_id: "{org14_id}"
    master_keys:
      - "../config/{org_path}/certs/ca/{org14_id}/master_public.key"
  - org_id: "{org15_id}"
    master_keys:
      - "../config/{org_path}/certs/ca/{org15_id}/master_public.key"
  - org_id: "{org16_id}"
    master_keys:
      - "../config/{org_path}/certs/ca/{org16_id}/master_public.key"
