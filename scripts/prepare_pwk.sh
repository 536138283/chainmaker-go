...
function show_help() {
    ...
    echo "    eg2: prepare_pwk.sh 4 1 11301 12301 32351 22351 23351"
    echo "    eg2: prepare_pwk.sh 4 1 11301 12301 32351 22351 23351 -c 1 -l INFO --hash SHA256 -v false  -j true  --vlog=INFO --jlog=INFO"
    echo "    eg2: prepare_pwk.sh 4 1 11201 12201 32251 22251 23351 -c 1 -l INFO --hash SM3    -v true   -j false --vlog=INFO --jlog=INFO"
}
