...
IMAGE_NAME=""
DOCKER_GO_IMAGE_NAME="chainmakerofficial/chainmaker-vm-engine:v2.4.0_alpha_qc"
DOCKER_JAVA_IMAGE_NAME="chainmakerofficial/chainmaker-vm-engine-java:v2.4.0_alpha_qc"
