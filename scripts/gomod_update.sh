...
go get chainmaker.org/chainmaker/consensus-dpos/v2@${TAG_OLD}
go get chainmaker.org/chainmaker/consensus-raft/v2@${BRANCH}
go get chainmaker.org/chainmaker/consensus-solo/v2@${TAG_OLD}
...
go get chainmaker.org/chainmaker/logger/v2@${TAG_OLD}
go get chainmaker.org/chainmaker/net-common@v1.2.4_qc
go get chainmaker.org/chainmaker/net-libp2p@v1.2.4_qc
go get chainmaker.org/chainmaker/net-liquid@v1.1.2_qc
...
go get chainmaker.org/chainmaker/vm-docker-go/v2@v2.3.2
...
go get chainmaker.org/chainmaker/vm-gasm/v2@v2.3.2
go get chainmaker.org/chainmaker/vm-wasmer/v2@v2.3.2
go get chainmaker.org/chainmaker/vm-wxvm/v2@v2.3.2
