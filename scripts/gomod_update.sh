...
go get chainmaker.org/chainmaker/consensus-tbft/v2@v2.3.1
...
go get chainmaker.org/chainmaker/net-common@v1.2.1
go get chainmaker.org/chainmaker/net-libp2p@v1.2.2_qc
go get chainmaker.org/chainmaker/net-liquid@v1.1.0
go get chainmaker.org/chainmaker/pb-go/v2@v2.3.1
go get chainmaker.org/chainmaker/protocol/v2@v2.3.1
go get chainmaker.org/chainmaker/sdk-go/v2@v2.3.1
go get chainmaker.org/chainmaker/store/v2@v2.3.2
...
go get chainmaker.org/chainmaker/utils/v2@v2.3.1
go get chainmaker.org/chainmaker/vm-docker-go/v2@v2.3.1
go get chainmaker.org/chainmaker/vm-engine/v2@v2.3.1
go get chainmaker.org/chainmaker/vm-native/v2@v2.3.1
go get chainmaker.org/chainmaker/vm-evm/v2@v2.3.1
go get chainmaker.org/chainmaker/vm-gasm/v2@v2.3.1
go get chainmaker.org/chainmaker/vm-wasmer/v2@v2.3.1
go get chainmaker.org/chainmaker/vm-wxvm/v2@v2.3.1
go get chainmaker.org/chainmaker/vm/v2@v2.3.1
