...
function show_help() {
    ...
    echo "    eg2: prepare.sh 4 1 11301 12301 32351 22351 -c 1 -l INFO -v true  "
    echo "    eg2: prepare.sh 4 1 11301 12301 32351 22351 -c 1 -l INFO -v false "
}
...
function generate_config() {
    ...
    set -- $(getopt -u -o c:l:v: "$@")   # -o 接收短参数， -l 接收长参数， 需要参数值的在参数后面添加:
    while [ -n "$1" ]; do
        case "$1" in
            -c) CONSENSUS_TYPE=$2
                shift ;;
